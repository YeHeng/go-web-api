...
import (
	...
	middleware "github.com/YeHeng/go-web-api/internal/middleware"
...
func New(logger *zap.Logger, options ...Option) (Mux, error) {
	...
	fmt.Println(color.Green(fmt.Sprintf("* [register port %s]", config.ProjectPort)))
